...
function DockTurn({ turn }: { turn: ComposerTurn }) {
  ...
  if (turn.role === "user") {
    return (
      <div className="flex justify-end">
        <div className="max-w-[85%] whitespace-pre-wrap break-words [overflow-wrap:anywhere] rounded-2xl bg-secondary px-3 py-1.5 text-sm text-secondary-foreground">
          {turn.text}
        </div>
      </div>
    );
  ...
  return (
    <div className="flex justify-start">
      <div className="max-w-[88%] rounded-2xl rounded-tl-sm border border-border bg-card px-3 py-2">
